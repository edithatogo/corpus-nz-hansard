...
from scripts.build_popolo_opencivicdata_public_endpoint import (
    build_popolo_opencivicdata_public_endpoint,
)
from scripts.check_popolo_opencivicdata_public_endpoint import MANIFEST_PATH, _failures, _json
...
class PopoloOpenCivicDataPublicEndpointTests(unittest.TestCase):
    ...
    def test_repo_manifest_was_written(self) -> None:
        ...
        self.assertEqual(
            manifest["artifact_name"], "Popolo / Open Civic Data public endpoint release"
        )
        self.assertEqual(
