...
- [x] Task: Create or update a Zenodo draft/new version, verify uploaded archive files and metadata, and route final publish through the protected environment.
- [x] Task: Update release evidence and Conductor track evidence with public URLs, revisions, DOI or draft IDs, and verification timestamps.
- [x] Task: Conductor - User Manual Verification 'Phase 4: First Monthly Release Proof' (Protocol in workflow.md)
